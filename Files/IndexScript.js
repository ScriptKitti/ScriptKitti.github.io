...
(function(headerHeight, curScroll, imgPerc, imgPos, imgSize, factor) {
  ...
  SKGitHubPost('ScriptKitti', 'ScriptKitti.github.io', 'articles/parallaxscrolljavascript/Votes.json', '7ad081ba672d3e7e958f0b48dd5333b9524021b7', 'application/json', 'json', JSON.stringify({"Votes": "2"}));
...
function fillPage() {
  $.getJSON('http://scriptkitti.github.io//Updates.json', function(data) {
    for (a = 0; a < data.latest.length; a++) {
      $('.latest-' + (a + 1)).attr('href', data.latest[a].link);
